...
namespace BibliotecaAPI.Controller.V1
{
    ...
    public class ComentariosController: ControllerBase
    {
        ...
        [HttpGet(Name = "CrearComentarioV1")]
        [AllowAnonymous]
        ...
        public async Task<ActionResult> Patch(Guid id, int libroId, JsonPatchDocument<ComentarioPatchDTO> patchDoc)
        {
            ...
            var cometarioDB = await context.Comentarios.FirstOrDefaultAsync(x => x.Id == id);
            ...
            var comentarioPatchDTO = mapper.Map<ComentarioPatchDTO>(cometarioDB);
            ...
            mapper.Map(comentarioPatchDTO, cometarioDB);
