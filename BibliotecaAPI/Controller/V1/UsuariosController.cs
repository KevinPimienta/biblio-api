...
namespace BibliotecaAPI.Controller.V1
{
    ...
    public class UsuariosController: ControllerBase
    {
        ...
        public async Task<IEnumerable<UsuarioDTO>> Get()
        {
            ...
            var usuarioDTO = mapper.Map<IEnumerable<UsuarioDTO>>(usuarios); //De aqui,  a configurar el mapeo en AutoMapperProfiles. IEnumerable, para mandar muchos objetos
            return usuarioDTO;
        }

        [HttpPost("registro", Name ="CrearRegistroV1")]
        ...
        public async Task<ActionResult> Put(ActualizarUsuarioDTO actualizarUsuarioDTO)
        {
            ...
            usuario.FechaNacimeinto = actualizarUsuarioDTO.FechaNacimiento;
