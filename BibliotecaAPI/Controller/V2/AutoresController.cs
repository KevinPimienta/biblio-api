...
namespace BibliotecaAPI.Controller.V2
{
    ...
    public class AutoresController : ControllerBase
    {
        ...
        //[OutputCache(Tags = [cache])]
        public async Task<ActionResult<AutorConLibrosDTOs>> Get([Description("El ID del autor")]int id, bool incluriLibros=false )
        {
            var queryable = context.Autores.AsQueryable();
            ...
            var autor = await queryable.SingleOrDefaultAsync(x => x.Id == id);
